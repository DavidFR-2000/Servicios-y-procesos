...
class CineTest {
    ...
    void buscarExiste() {
        ...
        assertEquals(valor_esperado,dao.buscarPelicula("Los vengadores"));
    }

    @Test
    void buscarNoExiste() {
        assertEquals("No existe esa pelicula",dao.buscarPelicula("Los vgfdengadores"));
    }


    @Test
    void dineroSuperheroes() {
        assertEquals(557.98,dao.dineroSuperheroes());
    }

    @Test
    void exportarmejores() {
        dao.exportarmejores(ruta_xml);
    }
}